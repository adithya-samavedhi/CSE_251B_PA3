...
train_dataset = voc.VOC('train', transform=input_transform,
                        target_transform=target_transform)
val_dataset = voc.VOC('val', transform=input_transform,
                      target_transform=target_transform)
test_dataset = voc.VOC('test', transform=input_transform,
                       target_transform=target_transform)
...
def train(args):
    ...
    for epoch in range(epochs):
        ...
        for iter, (inputs, labels) in enumerate(train_loader):
            ...
            # TODO transfer the input to the same device as the model's
            inputs = inputs.to(device)
            # TODO transfer the labels to the same device as the model's
...
if __name__ == "__main__":
    ...
    parser.add_argument('--scheduler', type=str, default='cosine',
                        help='Specify the learning rate scheduler that you want to use')
